...
> 来源：PDF Expert 免费 NDA 模板（pdfexpert.com/zh/nda-template），标准通用件。
> 采用方式：原文直接使用（英文为权威文本），附忠实中文对照供理解。填空处：双方名称/日期/签署。
> 中文对照为直译，不新增或删减条款。签署件私藏归档。
> 披露方身份栏填写方式（真名与身份证号均可不填）：正文填 **网名 + 联系方式**；主体认定依据双方签署时已完成实名互认的渠道（微信/支付宝/QQ 等，实名记录由渠道留存，不写入合同），纠纷时以渠道实名信息为准。
...
This Non-Disclosure Agreement (the "Agreement") is entered into by and between ____________ (the "Disclosing Party") and ____________ (the "Receiving Party") on ____ day of ____, ____, for the purpose of preventing the unauthorized disclosure of Confidential Information as defined below. The parties agree to enter into a confidential relationship concerning the disclosure of certain proprietary and confidential information ("Confidential Information").
...
IN WITNESS WHEREOF, the parties hereto have executed this Agreement as of the aforementioned effective date.

DISCLOSING PARTY — Signature: ____ Name: ____ Date: ____
RECEIVING PARTY — Signature: ____ Name: ____ Date: ____
...
本保密协议由 ____（"披露方"）与 ____（"接收方"）于 ____年__月__日签订，目的是防止下文定义的保密信息被未经授权披露。双方同意就某些专有及保密信息（"保密信息"）建立保密关系。

**1. 保密信息**：指披露方经营活动中具有或可能具有商业价值或其他用途的所有信息或材料。书面保密信息应由披露方标注"保密"字样或类似警示；口头传达的保密信息，披露方应及时提供书面说明表明该口头沟通构成保密信息。

**2. 保密信息除外情形**：接收方义务不适用于以下信息：(a) 披露时已公开或非因接收方过错后来公开的信息；(b) 披露前接收方已发现或创造的信息；(c) 接收方通过合法途径自披露方及其代表之外获得的信息；(d) 经披露方事先书面批准披露的信息。

**3. 接收方义务**：
3.1 接收方应为披露方的独有利益严格保密并保管保密信息。
3.2 接收方应仅在合理需要的范围内向雇员、承包商及第三方开放保密信息访问，并要求上述人员签署保护力度不低于本协议的保密限制。
3.3 未经披露方事先书面批准，接收方不得为自身利益使用、发布、复制或以其他方式向他人披露保密信息，或允许他人为自身利益或损害披露方利益使用。
3.4 披露方书面要求时，接收方应立即归还其持有的与保密信息相关的一切记录、笔记及其他书面、印刷或有形材料。

**4. 期限**：保密条款在本协议终止后继续有效；接收方的保密义务持续至保密信息不再构成商业秘密，或披露方书面通知解除接收方义务，以先发生者为准。

**5. 无担保**：保密信息按"现状"提供，披露方不对其完整性、准确性或性能作任何明示或默示担保。

**6. 禁令救济**：双方确认保密信息具有独特而宝贵的性质，未经授权的散布可能毁损其价值；因此类泄露造成的损失难以计算，双方同意披露方有权请求禁令救济以防止违反本协议条款的保密信息传播。该禁令救济与其他法律或衡平法上的救济并行。披露方有权追偿为获得救济支出的费用（含合理律师费）。与本协议相关的诉讼中，胜诉方有权追偿合理的律师费及支出。

**7. 违约通知**：接收方发现自身或其代表对保密信息有任何未经授权的使用、披露或违反本协议的情形时，应立即通知披露方，并配合披露方取回保密信息、防止进一步未经授权使用。

**8. 关系**：本协议任何内容不得视为双方构成合伙、合资或雇佣关系。

**9. 可分性**：法院认定本协议任何条款无效或不可执行时，其余条款应按最符合双方意图的方式解释。

**10. 完整性**：本协议构成双方就该主题的完整共识，取代此前一切建议、协议、陈述与理解；修改须经双方书面签署。

**11. 弃权**：未行使本协议项下任何权利不构成对先前或后续权利的放弃。

**12. 转让**：本协议及双方义务对双方代表、受让人及继承人具有约束力。

**13. 其他**：条款标题仅为参考，不用于协议解释。

特此为证，双方于上述生效日期签署本协议。

披露方——签名：____ 姓名：____ 日期：____
接收方——签名：____ 姓名：____ 日期：____
